  ...
  public: {
    Tables: {
      ...
      walkie_channel_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "walkie_channel_members_channel_id_fkey"
            columns: ["channel_id"]
            isOneToOne: false
            referencedRelation: "walkie_channels"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "walkie_channel_members_leader_id_fkey"
            columns: ["leader_id"]
            isOneToOne: false
            referencedRelation: "leaders"
            referencedColumns: ["id"]
      ...
      walkie_channels: {
        ...
        Relationships: [
          {
            foreignKeyName: "walkie_channels_cabin_id_fkey"
            columns: ["cabin_id"]
            isOneToOne: false
            referencedRelation: "cabins"
            referencedColumns: ["id"]
