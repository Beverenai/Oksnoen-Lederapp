...
const navItems = [
  ...
  { key: 'new-period', label: 'Start ny periode', desc: 'Arkiver nurse-logger og slett deltagere', icon: RotateCcw, color: 'bg-destructive/15 text-destructive' },
];
