  ...
  return (
    <div className="h-dvh bg-background flex flex-col overflow-hidden overflow-x-hidden w-full max-w-full pl-safe pr-safe">
      ...
      <main 
        ...
        className="lg:pl-64 lg:pt-0 flex-1 w-full min-w-0 lg:min-h-screen app-content lg:pb-0 overflow-y-auto overflow-x-hidden max-w-full className="lg:pl-64 lg:pt-0 flex-1 w-full min-w-0 lg:min-h-screen app-content lg:pb-0 overflow-y-auto overflow-x-hidden max-w-full pb-[calc(var(--nav-h)+env(safe-area-inset-bottom,0px))] lg:pb-0" lg:pb-0"
