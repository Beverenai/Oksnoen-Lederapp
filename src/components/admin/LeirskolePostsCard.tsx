...
import { CalendarClock, Play, Plus, Trash2, Lock, LockOpen, Moon } from 'lucide-react';
import {
 ...
 */
export function LeirskolePostsCard({ week, staff }: { week: LeirskoleWeek; staff: StaffRow[] }) {
    ...
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          ...
          Legg inn vaktene, generer, og juster manuelt ved behov.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          {byDay.length === 0 && (
            <p className="text-xs text-muted-foreground">Ingen vakter lagt inn for denne uken ennå.</p>
          )}
        </div>
      </CardContent>
    </Card>
